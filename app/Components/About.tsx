  ...
  return (
    <section id="about" className="container mx-auto overflow-hidden px-2 sm:px-4 mt-20">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-20">
        ...
        {/* Columna 2: Lista 1 - Se añade lg:pt-13 para alinear con el texto */}
        <div className="lg:col-span-3 flex flex-col gap-4 lg:pt-13">
        ...
        {/* Columna 3: Lista 2 - Se añade lg:pt-13 para que empiece a la misma altura */}
        <div className="lg:col-span-3 flex flex-col gap-4 lg:pt-13">
          <ul className="space-y-4">
