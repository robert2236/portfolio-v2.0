  ...
  const projects = [
    {
      ...
      description: "Lorem, ipsum dolor sit amet consectetur adipisicing elit. Asperiores id doloremque ut voluptatum, saepe iste ad cum consequuntur. Odio eum fuga quisquam ratione labore pariatur.",
    ...
    <section className="container mx-auto px-2 py-36 sm:px-4" id="portfolio">
      ...
      <div className="grid grid-cols-12 gap-6">
        {projects.map((project) => (
          <div 
            key={project.id}
            className={`mix ${project.category} col-span-12 flex h-[400px] flex-col overflow-hidden rounded-lg bg-white shadow-[0_0.5rem_1rem_rgba(0,_0,_0,_0.15)] md:col-span-6 lg:col-span-4`}
            ...
            <figure className="h-full flex flex-col">
              ...
              <div className="mt-auto flex justify-center gap-10 p-3">
                <a 
                  ...
                  className="flex items-center gap-1 rounded-full bg-primary-500 px-4 py-2 text-white shadow-[inset_0px_-4px_2px_rgb(0_0_0_/_25%)] hover:animate-zoom transition-transform hover:scale-105"
                >
                  <svg 
                    stroke="currentColor" 
                    fill="currentColor" 
                ...
                <a 
                  ...
                  className="flex items-center gap-1 rounded-full border-2 border-primary-500 px-4 py-2 text-primary-500 hover:animate-zoom transition-transform hover:scale-105"
                >
                  <svg 
                    stroke="currentColor" 
                    fill="currentColor" 
